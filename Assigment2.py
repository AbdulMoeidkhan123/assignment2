...
#show first 5 rows of argicultural land data
arg_land_data.head(5)
...
plt.bar(np.arange(arg_land_data_2000.shape[0])+0.3,
        ...
        color='darkslategray',width=barWidth, label='2000')
...
plt.bar(np.arange(cy_data_1990.shape[0]),
        ...
        color='lightseagreen', width=barWidth, label='1990')
...
plt.bar(np.arange(cy_data_2000.shape[0])+0.3,
        ...
        color='yellow',width=barWidth, label='2000')
...
ger_urb_pop =  urban_pop[urban_pop['country'] == 'Germany'] 
ind_urb_pop = urban_pop[urban_pop['country'] == 'India'] 
jap_urb_pop = urban_pop[urban_pop['country'] == 'Japan'] 
mex_urb_pop = urban_pop[urban_pop['country'] == 'Mexico'] 
neth_urb_pop = urban_pop[urban_pop['country'] == 'Netherlands'] 
rsa_urb_pop = urban_pop[urban_pop['country'] == 'Russian Federation'] 
...
plt.plot(ger_urb_pop.year, ger_urb_pop.urban_population,':',label='Germany')
plt.plot(ind_urb_pop.year, ind_urb_pop.urban_population,'-r',label='India')
plt.plot(jap_urb_pop.year, jap_urb_pop.urban_population,'--b',label='Japan')
plt.plot(mex_urb_pop.year, mex_urb_pop.urban_population,':g',label='Mexico')
plt.plot(neth_urb_pop.year, neth_urb_pop.urban_population,'--',label='Netherlands')
plt.plot(rsa_urb_pop.year, rsa_urb_pop.urban_population,':c',label='Russia')
plt.plot(turk_urb_pop.year, turk_urb_pop.urban_population,':k',label='Turkiya')
plt.plot(ukr_urb_pop.year, ukr_urb_pop.urban_population,':r',label='Ukraine')
plt.plot(us_urb_pop.year, us_urb_pop.urban_population,':r',label='US')
...
# create growth table of arable land
# between 1990 and 2020
arable_land_per = orig_df[['country','year','arable_land']]
arable_land_per.head(5)


# Data Related to 1990, 2010 and 2020
land_per_1990 = arable_land_per[arable_land_per['year']==1990].dropna()
land_per_2010 = arable_land_per[arable_land_per['year']==2010].dropna()
land_per_2020 = arable_land_per[arable_land_per['year']==2020].dropna()


# Show data in land_per dataframe over
# the years
land_per_2020.head(12)

land_per_1990.head(12)

land_per_2010.head(12)
